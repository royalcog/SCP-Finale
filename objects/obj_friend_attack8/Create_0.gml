...
guns_fade_in_duration = 45; // ~0.75s fade before the guns fire their first shot

rock_started = false;
rock_inst = noone;
rock_delay = guns_fade_in_duration + 100; // ~1.6s after guns start shooting before the punches join in
