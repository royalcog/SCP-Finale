...
if sprite_index == spr_gerson_hammer_idle_lantern_left && turn_light_change == false
{
	light_offset_x -= 50;	
	turn_light_change = true;
}

else if sprite_index == spr_gerson_hammer_idle_lantern_right && turn_light_change == true
{
	light_offset_x += 50;	
